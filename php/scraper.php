...
$result = mysql_query("SELECT DISTINCT  `URL` FROM  `S17` WHERE Courses =  '$search'");
...
if (preg_match("/(404|500)/", $http_code) === 1) {
	...
	$result = mysql_query("SELECT DISTINCT  `INFO` FROM  `S17` WHERE Courses =  '$search'");
